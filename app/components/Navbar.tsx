...
import { Home, BarChart2, Linkedin, Menu, X, CheckCircle, FileText, File, Settings } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-3 no-overflow">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-1">
            ...
            <NavLink href="/resume-builder" active={pathname === '/resume-builder'}>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pt-2 pb-3 space-y-1 mobile-container">
            ...
            <MobileNavLink href="/resume-builder" active={pathname === '/resume-builder'}>
              <File className="w-4 h-4 mr-2" />
              Resume Builder
            </MobileNavLink>
