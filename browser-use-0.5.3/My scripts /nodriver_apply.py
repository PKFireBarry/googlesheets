...
async def process_hybrid_apply(task_id: str, job_url: str, api_key: str, user_data: UserData, resume_file: UploadFile | None, file_url: str | None):
    ...
    try:
        ...
        browser_args = [
            ...
            '--disable-component-update',     # Prevent component updates that might reveal automation
            '--disable-sync',                 # Disable sync to reduce fingerprinting
            '--disable-translate',            # Disable translate to reduce detection
        ]
